#include "PokeControllerForESP32_Func.h"
...
{
  //CustomKeyboard().begin();
  // CustomKeyboard().releaseAll();
  //Keyboard.begin();
  //USB.begin();
}
...
void Type_string(char* str)
{
  ...
  while (true)
  {
    ...
    {
      //CustomKeyboard().pushkey(t_str[len]);
      //Keyboard.write(t_str[len]);
    }
    len++;
  }
}
